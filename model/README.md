...
Run this script to go from gamelogs to trained model using all defaults. For more custom configurations see below.
...
| `SCRAMBLE_TRAIN_AND_TEST_SETS` | `True`       | False = chronological split of train and test data |

## Notebooks

- [experiments.ipynb](experiments.ipynb) — multi-config experiment comparison (Linear Regression + Neural Network)
